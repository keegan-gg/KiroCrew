...
this safe to place in a hot path: with ``decisions.enabled`` false (the default)
the call performs no ``await``, no IO and no import beyond this module.
...
from kiro_crew.decisions.oracle import DecisionOracle
