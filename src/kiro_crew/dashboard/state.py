...
class StageBoundary:
    ...
    def arm(self, stage: int, *, consumed: bool = False) -> None:
        ...
        self.recovery_retrigger_count = 0
...
class _ChatSlot:
    ...
    @property
    def _recovery_retrigger_count(self) -> int:
        return self.stage_boundary.recovery_retrigger_count

    @_recovery_retrigger_count.setter
    def _recovery_retrigger_count(self, value: int) -> None:
        self.stage_boundary.recovery_retrigger_count = value
    ...
    def running(self) -> bool:
        return bool(
            self.turn_running
            or (self.stage_boundary.stage is not None and not self._plan_cancelled)
        )
