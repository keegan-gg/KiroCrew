...
def isolated_python_argv(
    *args: str,
    ...
    Kiro Crew itself may have been installed there. Callers whose import path
    is pinned independently may set ``force_isolation`` to retain ``-s`` in
    that case. This helper is for Kiro Crew-owned processes and installers, not
    user scripts or project tools.
    """
    import site
